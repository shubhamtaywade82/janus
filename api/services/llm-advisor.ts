...
export interface SignalContext {
  ...
  imbalance?: number;
  atrPct?: number;
  // Brain-gate controls (set by the auto-executor from auto_executor_config). When
  // brainGateEnabled is false the legacy multi-key LLM pipeline is used instead of the Brain.
  brainGateEnabled?: boolean;
  brainShadowMode?: boolean;
}
