...
// The Brain now participates INLINE as a shadow evaluator inside the auto-executor
// (Signal → Governor → Brain.evaluate() → Executor). This scheduler only drives the
// periodic strategy-evolution job; there is no separate "driver" loop.
